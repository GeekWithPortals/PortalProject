...
public class FPSController : PortalTraveller {
    ...
    void Update () {
        ...
        if (key_z && !key_q && !key_s && !key_d) // avancer
        {
            //anim.Play("chell.qc_skeleton|a_run_aimmatrix_mid_center");
        } 
        else if (!key_z && !key_q && key_s && !key_d) // reculer
        {
            //anim.Play("chell.qc_skeleton|a_run_aimmatrix_mid_center");
        }
        else if (!key_z && key_q && !key_s && !key_d) // gauche
        {
            //anim.Play("chell.qc_skeleton|a_run_aimmatrix_mid_center");
        }
        else if (!key_z && !key_q && !key_s && key_d) // droite
        {
            //anim.Play("chell.qc_skeleton|a_run_aimmatrix_mid_center");
        }
    }
